...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERMISSIONS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERMISSIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERMISSIONS actions', async () => {
      const expectedActions = [
        {
